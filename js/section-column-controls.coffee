...
leadpagesUX.sectionColumnControls =
  ...
  bindings: ->
    ...
    @builderScreen.querySelector('.pageStylesControl i').addEventListener( 'click', (e) ->
      pageArea = document.querySelector('.builderBody')
      paneData = pageArea.dataset
      _t.paneSwapArea = pageArea
      _t.paneSwap(state = 'on', pane = 'page', paneData)
    )
    ...
    [].forEach.call(@sectionStyles, (sectionStyle) ->
      ...
      sectionStyle.querySelector('.addColumn').addEventListener( 'click', (e) ->
        _t.addColumn(section, columnStylesContainer)
      )
    )
  ...
  bindColumnStyleFunk: ->
    ...
    [].forEach.call(columnStyles, (columnStyle) ->
      ...
      sectionName = columnStyle.parentElement.parentElement.parentElement.dataset.section
      section = document.querySelector("#builderSection__#{sectionName}")
      columnStylesContainer = columnStyle.parentElement.parentElement
      ...
      columnStyle.addEventListener('click', (e) ->
        ...
        if e.srcElement.classList.contains('deleteColumn')
          ...
          if window.confirm('Are you sure you want to delete this column?')
            ...
            _t.resetColumns(section, columnStylesContainer)
            # _t.builderScreen.querySelector('.sectionStylesContainer').classList.remove('section-isOpen')
  ...
  # add column
  addColumn: (section,columnStylesContainer) ->
    ...
    # recount
    @resetColumns(section,columnStylesContainer)
  ...
  toggleSectionFromTrigger: (sectionName) ->
    @paneToggle('pageStyles') unless @builderScreen.classList.contains('pageStylesPane-isOpen')
